...
public class PercentCost extends ValidatedData implements IAdditional {
	...
	public PercentCost(BigDecimal value) {
		this.value = value;
		validate();
	}
	...
	public BigDecimal getValueDeterminedBy(BigDecimal ordersTotal) {
		...
		return this.value.divide(new BigDecimal(100)).multiply(ordersTotal);
	}
}
